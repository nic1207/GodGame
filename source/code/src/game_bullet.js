...
var GameBullet = cc.Sprite.extend({
  ...
  moveRight: function() {
    //this.getPosition().x = this.getPosition().x+1;
    //this.setPosition(cc.p(this.getPosition().x, this.getPosition().y));
    //var actionTo = cc.MoveBy.create(0.1, cc.p(this.getPosition().x + 3, 0));
    //console.log(this.getPosition().x);
    //var actionTo = cc.ScaleTo.create(0.2, 3);
    this.velocity.x = 10;
    this.velocity.y = Math.abs(1.7);
