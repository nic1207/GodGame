...
var GamePauseLayer = cc.LayerColor.extend({
  ...
  init:function() {
    ...
    var menuItemBuy = cc.MenuItemSprite.create(cc.Sprite.create(s_MenuShop), 
      cc.Sprite.create(s_MenuShop), this.onBuy, this);
    ...
    var menu = cc.Menu.create(menuItemBuy,menuItemResume,menuItemExit);
